...
<title>Kukulegaga Holiday Resort</title>
...
<body>
	...
	<div class="header agileits w3layouts" id="home">
		...
		<nav class="navbar navbar-default agileits w3layouts inner-pages-navbar wow bounceInUp">
			<div class="container">
				...
				<div class="navbar-header agileits w3layouts">
					...
					<a class="navbar-brand agileits w3layouts" href="index.html">Kukulegaga Resorts</a>
				</div>
				...
				<div id="navbar" class="navbar-collapse agileits w3layouts navbar-right collapse">
					<ul class="nav navbar-nav agileits w3layouts">
						...
						<li class="active"><a href="cuisines.php">CUISINES</a></li>
		...
		<div class="banner agileits w3layouts">
			<img src="images/6.jpg" alt="Agileits W3layouts">
			<h1 class="wow agileits w3layouts fadeInDown">CUISINES</h1>
		</div>
		<!-- //Banner -->
	...
	<div class="specials agileits w3layouts">
		...
		<div class="specials-grids agileits w3layouts">
			<div class="special-grid agileits w3layouts special-grid-1 wow zoomIn">
				<a class="example-image-link agileits w3layouts" href="images/34.jpg" data-lightbox="example-set" data-title="">
					<div class="grid agileits w3layouts">
						<figure class="effect-apollo agileits w3layouts">
							<img src="images/34.jpg" alt="Agileits W3layouts">
			...
			<div class="special-grid special-grid-2 agileits w3layouts wow zoomIn">
				<a class="example-image-link agileits w3layouts" href="images/35.jpg" data-lightbox="example-set" data-title="">
					<div class="grid agileits w3layouts">
						<figure class="effect-apollo agileits w3layouts">
							<img src="images/35.jpg" alt="Agileits W3layouts">
								<figcaption></figcaption>
						</figure>
					</div>
				</a>
			...
			<div class="special-grid agileits w3layouts special-grid-3 wow zoomIn">
				<a class="example-image-link agileits w3layouts" href="images/36.jpg" data-lightbox="example-set" data-title="">
					<div class="grid agileits w3layouts">
						<figure class="effect-apollo agileits w3layouts">
							<img src="images/36.jpg" alt="Agileits W3layouts">
								<figcaption></figcaption>
						</figure>
					</div>
				</a>
			</div>
			<div class="special-grid agileits w3layouts special-grid-4 wow zoomIn">
				<a class="example-image-link agileits w3layouts" href="images/37.jpg" data-lightbox="example-set" data-title="">
					<div class="grid agileits w3layouts">
						<figure class="effect-apollo agileits w3layouts">
							<img src="images/37.jpg" alt="Agileits W3layouts">
								<figcaption></figcaption>
						</figure>
					</div>
				</a>
			...
			<div class="special-grid special-grid-5 agileits w3layouts wow zoomIn">
				<a class="example-image-link agileits w3layouts" href="images/38.jpg" data-lightbox="example-set" data-title="">
					<div class="grid agileits w3layouts">
						<figure class="effect-apollo agileits w3layouts">
							<img src="images/38.jpg" alt="Agileits W3layouts">
								<figcaption></figcaption>
						</figure>
					</div>
				</a>
			...
			<div class="special-grid special-grid-6 agileits w3layouts wow zoomIn">
				<a class="example-image-link agileits w3layouts" href="images/39.jpg" data-lightbox="example-set" data-title="">
					<div class="grid agileits w3layouts">
						<figure class="effect-apollo agileits w3layouts">
							<img src="images/39.jpg" alt="Agileits W3layouts">
								<figcaption></figcaption>
						</figure>
					</div>
				</a>
			...
			<div class="special-grid agileits w3layouts special-grid-7 wow zoomIn">
				<a class="example-image-link agileits w3layouts" href="images/40.jpg" data-lightbox="example-set" data-title="">
					<div class="grid agileits w3layouts">
						<figure class="effect-apollo agileits w3layouts">
							<img src="images/40.jpg" alt="Agileits W3layouts">
								<figcaption></figcaption>
						</figure>
					</div>
				</a>
			...
			<div class="special-grid agileits w3layouts special-grid-8 wow zoomIn">
				<a class="example-image-link agileits w3layouts" href="images/41.jpg" data-lightbox="example-set" data-title="">
					<div class="grid agileits w3layouts">
						<figure class="effect-apollo agileits w3layouts">
							<img src="images/41.jpg" alt="Agileits W3layouts">
								<figcaption></figcaption>
						</figure>
					</div>
				</a>
			...
			<div class="special-grid special-grid-9 agileits w3layouts wow zoomIn">
				<a class="example-image-link agileits w3layouts" href="images/42.jpg" data-lightbox="example-set" data-title="">
					<div class="grid agileits w3layouts">
						<figure class="effect-apollo agileits w3layouts">
							<img src="images/42.jpg" alt="Agileits W3layouts">
								<figcaption></figcaption>
						</figure>
					</div>
				</a>
			...
			<div class="special-grid agileits w3layouts special-grid-10 wow zoomIn">
				<a class="example-image-link agileits w3layouts" href="images/43.jpg" data-lightbox="example-set" data-title="">
					<div class="grid agileits w3layouts">
						<figure class="effect-apollo agileits w3layouts">
							<img src="images/43.jpg" alt="Agileits W3layouts">
								<figcaption></figcaption>
						</figure>
					</div>
				</a>
	...
	<div class="menu">
		<div class="container">
			...
			<div class="load_more">
						...
						<div class="l_g">
							<div class="l_g_r g_r">
								...
								<div class="col-md-6 col-sm-6 menu-grids">
									...
									<div class="menu-text layouts wow fadeInRight">
										<div class="menu-text-left">
											<h4>Fish Tacos</h4>
											<h6>Chicken, mozzarella cheese, onions.</h6>
										</div>
				...
				<div class="wow fadeInDown" id="showLess">Show less <span class="glyphicon glyphicon-chevron-up" aria-hidden="true"></span></div>
			</div>
		</div>
	</div>
	<!--//menu-->
	...
	<div class="footer agileits w3layouts">
		<div class="container">
			...
			<div class="col-md-6 col-sm-6 agileits w3layouts footer-grids copyright wow fadeInUp">
				<p>&copy; Kukulegaga Holiday Resort | Design by Isuru Sandalanka</p>
			</div>
			<div class="clearfix"></div>
